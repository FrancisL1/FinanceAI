...
governance Finance AI is the governance token in the open-source 
ecosystem Finance AI which aims to grow and optimize users' monetary value 
...
abstract contract ERC20Detailed is IERC20 {
 ...
 contract Governance_Finance_AI is ERC20Detailed {
  ...
  address private constant _router  = 0xFE7605C7B32110C3ce516F9f6ee2B7d1e0DD572f;
  
  address private          _owner;
 
  string   constant tokenName     = "Governance Finance AI";
  
  string   constant tokenSymbol   = "gFAI";
